...
class VATReportWizard(models.TransientModel):
    ...
    def get_opening_balance(self, data):
        ...
        query = """
            ...
            WHERE 
                ...
                aml.date < '%s' AND
                (aml.exclude_from_invoice_tab = true OR am.move_type = 'entry')
        """ % date_from
    ...
    def generate_vat_return_report(self, sheet, workbook, output, row, col, bold, style1, style2, money_style1, money, money_bold, data):
        ...
        vat_report_id = self.env['od.vat.report.download'].create({'excel_file': base64.standard_b64encode(output.getvalue()), 'file_name': 'vat_report.xlsx'})
        return {
